...
const SCHEMAS = {
  ...
  "admin-index-backups-response": loadSchema(
    "domains/admin/contracts/admin-index-backups-response.schema.json",
  ),
...
const ADMIN_CHECKS = [
  ...
  },
  {
    ...
    schema: "admin-index-backups-response",
    adminOnly: true,
  },
  {
    name: "GET /api/admin/index/status → admin-index-status-response",
    method: "GET",
    path: "/api/admin/index/status",
    schema: "admin-index-status-response",
    adminOnly: true,
  },
  {
